...
public class Main
{
    ...
    private static String dataFile = "src\\resources\\map.json";//мой путь
    ...
    private static Station takeStation(String message)//возвращает объект-станцию по названию
    {
        for(;;)
        {
            ...
            String line = scanner.nextLine().trim(); //Здесь line в качестве строки
            Station station = stationIndex.getStation(line);
            if(station != null) {
                return station;
            }
            System.out.println("Станция не найдена :(");//а здесь не должно быть else?
        }
    }
